export class ServiceName {
  ...
  public static CPTANTHULOAIKHOANGSAN = "cptanthuloaikhoangsan";
  public static CPTANTHUKHUVUC = "cappheptanthukhuvuc";

  // Cấp phép đấu giá
  public static CPDAUGIAKHAITHAC = "capphepdaugiakhaithac";
  public static CPDAUGIAKHUVUC = "capphepdaugiakhuvuc";
  // Tính tiền cấp quyền
  ...
  public static GMEDIA = "media";
  public static OBJMEDIA = "objmedia";
  public static ID_DVHC = "id";
  public static TEN_DVHC = "name";
  public static TIEUCHUAN = "tieuchuan";
  public static THAMSO = "thamso";
  public static TIEUCHUANCHATLUONG = "tccl";
  public static DONVIDO = "donvido";
  public static TANGCHUANUOC = "tangchuanuoc";
  public static LOAISOLIEU = "loaisolieu";
  public static DUAN = "duan";
  public static COQUANTOCHUC = "coquantochuc";
  public static GIENGQUANTRAC = "giengquantrac";
  public static GIENGKHAITHAC = "giengkhaithac";
  public static XANUOCTHAI = "diemxathai";
  public static DIATANG = "diatanggieng";
  public static KIENTRUCGIENG = "cautrucgieng";
  public static KIEMTRAKYTHUAT = "GKiemtracongtrinh";
  public static OBJTHAMSO = "objthamso";
  public static DLGIAMSATTS = "giamsatts";
  public static DLQUANTRACTS = "quantracts";
  public static DLQUANTRACTSHIS = "quantractsHis";
  public static KETQUAQUANTRAC = "ketquaquantrac";
  public static LAYER = "layers";
  public static MAP = "map";
  public static LAYERGROUP = "layergroups";
  public static MAPLAYER = "maplayer";
  public static MLAYERGROUP = "grouplayer";
  ...
  public static OBJOPTVALUE = "optsValue";
  public static OBJTHIETBIQUANTRAC = "objthietbiquantrac";
  public static SEARCH = "search";
  public static USERROLE = "v1/Authorize/GetActionAlternateKeysByCurrentUser";
  public static CHUDE = "categories";
  public static TINTUC = "articles";
}
