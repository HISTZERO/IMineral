...
@Component({
  ...
  templateUrl: './dcm-donvihanhchinh-list.component.html',
  styleUrls: ['./dcm-donvihanhchinh-list.component.scss']
})
export class DcmDonvihanhchinhListComponent implements OnInit {
