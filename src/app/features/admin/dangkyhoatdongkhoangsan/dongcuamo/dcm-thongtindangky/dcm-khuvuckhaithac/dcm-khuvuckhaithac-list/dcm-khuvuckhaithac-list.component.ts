...
@Component({
  ...
  templateUrl: './dcm-khuvuckhaithac-list.component.html',
  styleUrls: ['./dcm-khuvuckhaithac-list.component.scss'],
  providers: [DetailRowService]
})
export class DcmKhuvuckhaithacListComponent implements OnInit {
