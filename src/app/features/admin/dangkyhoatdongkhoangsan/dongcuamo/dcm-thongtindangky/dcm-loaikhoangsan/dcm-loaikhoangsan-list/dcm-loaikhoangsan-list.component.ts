...
import {OutputDkKhaiThacLoaiKhoangSan} from "src/app/models/admin/dangkyhoatdongkhoangsan/dkkhaithacloaikhoangsan.model";
...
@Component({
  selector: 'app-dcm-loaikhoangsan-list',
  templateUrl: './dcm-loaikhoangsan-list.component.html',
  styleUrls: ['./dcm-loaikhoangsan-list.component.scss']
})
export class DcmLoaikhoangsanListComponent implements OnInit {
