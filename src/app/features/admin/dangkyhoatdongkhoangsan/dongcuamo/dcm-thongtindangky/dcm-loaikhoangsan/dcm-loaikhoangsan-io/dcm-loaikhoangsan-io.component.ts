...
@Component({
  ...
  templateUrl: './dcm-loaikhoangsan-io.component.html',
  styleUrls: ['./dcm-loaikhoangsan-io.component.scss']
})
export class DcmLoaikhoangsanIoComponent implements OnInit {
  // Chứa dữ liệu Form
