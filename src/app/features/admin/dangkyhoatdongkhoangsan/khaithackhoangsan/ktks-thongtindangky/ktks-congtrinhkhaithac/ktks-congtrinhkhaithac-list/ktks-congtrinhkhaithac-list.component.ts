...
@Component({
  selector: 'app-ktks-congtrinhkhaithac-list',
  templateUrl: './ktks-congtrinhkhaithac-list.component.html',
  styleUrls: ['./ktks-congtrinhkhaithac-list.component.scss']
})
export class KtksCongtrinhkhaithacListComponent implements OnInit {
