...
export class DangkykhaithacvlxdIoComponent implements OnInit {
  ...
  // tslint:disable-next-line: no-output-rename
  @Output() selectIdDangKyKhaiThacVLXDEvent: EventEmitter<string> = new EventEmitter();
  ...
  private formInit() {
    this.dangKyKhaiThacVLXDIOForm = this.formBuilder.group({
      ...
      donvikhoiluong: ["", Validators.required],
  ...
  private setValidation() {
    this.validationErrorMessages = {
      ...
      donvikhoiluong: {required: this.dataTranslate.DANGKYHOATDONGKHOANGSAN.dangkykhaithacvlxd.donvikhoiluongRequired},
  ...
  private selectIddangKyKhaiThacVLXD() {
    this.selectIdDangKyKhaiThacVLXDEvent.emit(this.dangKyKhaiThacVLXD.iddangkykhaithac);
  }
