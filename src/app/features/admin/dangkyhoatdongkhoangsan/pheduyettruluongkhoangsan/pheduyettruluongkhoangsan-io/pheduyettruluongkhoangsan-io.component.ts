...
@Component({
  ...
  templateUrl: './pheduyettruluongkhoangsan-io.component.html',
  styleUrls: ['./pheduyettruluongkhoangsan-io.component.scss']
})
export class PheduyettruluongkhoangsanIoComponent implements OnInit {
  ...
  public btnArray = ButtonBackPheDuyetTruLuongKhoangSan;
