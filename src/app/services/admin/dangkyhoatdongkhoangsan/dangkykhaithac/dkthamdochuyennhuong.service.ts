...
export class DkthamdochuyennhuongService extends RepositoryEloquentService {
  ...
  constructor(public httpClient: HttpClient) {
    ...
    this.setServiceInfo({
      ...
      apiUrl: environment.apiIMineral + ServiceName.DANGKYTHAMDOCHUYENNHUONG
    });
  }
  ...
  public deleteDangKyChuyenNhuongByIdHoSo(idHoSo: string) {
    try {
      this.setServiceInfo({
        apiUrl: environment.apiIMineral + ServiceName.DANGKYTHAMDOCHUYENNHUONG + "/deletebyidhoso"
      });
